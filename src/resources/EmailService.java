...
public class EmailService {
    ...
    public void sendEmail(String email, String message) {
        ...
        try {
            ...
            BufferedReader in = new BufferedReader(new FileReader("src/resources/EmailBody.html"));
            String str;
            ...
            content = content.replace("THISISYOURPASSWORD", new String("Hola soy el Yerys y me acabo de sacar la pollísima"));
